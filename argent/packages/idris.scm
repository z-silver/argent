...
(define* (make-idris2 #:key version source-hash input-idris2
                      (final? #f))
  (package
    (name (if final? "idris2" "idris2-bootstrap"))
    (version version)
    (source
     (origin
       (method git-fetch)
...
(define-public idris2-bootstrap-0.2.1
  (make-idris2 #:version "0.2.1"
               #:source-hash
               "044slgl2pwvj939kz3z92n6l182plc5fzng1n4z4k6bg11msqq14"
               #:input-idris2 idris2-boot))

(define-public idris2-bootstrap-0.2.2
  (make-idris2 #:version "0.2.2"
               #:source-hash
               "0krhpkakp9yar54c2gnj5w97j5iyw8gvjxiq7biachm1y07ai7y5"
               #:input-idris2 idris2-bootstrap-0.2.1))

(define-public idris2-bootstrap-0.3.0
  (make-idris2 #:version "0.3.0"
               #:source-hash
...
(define-public idris2-bootstrap-0.8.0
  (make-idris2 #:version "0.8.0"
               #:source-hash
               "1vbxgrnpn18cr7k16y40sv7n08qjjrqxr1q0ij9x8f30z944vw9j"
